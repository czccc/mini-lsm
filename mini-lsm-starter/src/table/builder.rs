...
impl SsTableBuilder {
    ...
    pub fn add(&mut self, key: KeySlice, value: &[u8]) {
        if !self.builder.add(key, value) {
            ...
            self.meta.push(BlockMeta {
                ...
                first_key: KeyBytes::from_bytes_with_ts(first_key.0.into(), first_key.1),
                last_key: KeyBytes::from_bytes_with_ts(last_key.0.into(), last_key.1),
            });
    ...
    pub fn build(
        ...
        self.meta.push(BlockMeta {
            offset: self.data.len(),
            first_key: KeyBytes::from_bytes_with_ts(self.first_key.0.into(), self.first_key.1),
            last_key: KeyBytes::from_bytes_with_ts(self.last_key.0.into(), self.last_key.1),
        });
